...
def start_timer():
    ...
    if reps == 2 or reps == 4 or reps == 6:
        Label.config(timer, text="SHORT BREAK", fg=RED)
        count_down(SHORT_BREAK_MIN)
        
    elif reps == 1 or reps == 3 or reps ==5 or reps == 7:
        Label.config(timer, text="WORK TIME", fg=GREEN)

        count_down(WORK_MIN)
       
    elif reps == 8:
        Label.config(timer, text="LONG BREAK")
...
tomato_img = PhotoImage(file="Intermediate days\\day28\\tomato.png")
